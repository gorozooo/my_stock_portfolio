...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "gorozooo.com", "www.gorozooo.com"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "portfolio.context_processors.page_info",
                "portfolio.context_processors.bottom_nav_pages",
                'portfolio.context_processors.bottom_nav_items',
            ],
        },
    },
]
